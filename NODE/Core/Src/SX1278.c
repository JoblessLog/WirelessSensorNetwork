...
void SX1278_config(SX1278_t *module) {
	...
	SX1278_SPIWrite(module, RegSyncWord, 0x14);
...
uint8_t SX1278_available(SX1278_t *module) {
	return SX1278_LoRaRxPacket(module,1);
}
...
int SX1278_RSSI_LoRa(SX1278_t *module) {
	uint32_t temp;
	temp = SX1278_SPIRead(module, 0x1a); //Read RegRssiValue, Rssi value
	temp = temp-164; //127:Max RSSI, 137:RSSI offset
	return temp;
}

uint8_t SX1278_SNR_LoRa(SX1278_t *module) {
	uint32_t temp;
	temp = SX1278_SPIRead(module, 0x19); //Read SNR
	return (uint8_t) temp;
}
